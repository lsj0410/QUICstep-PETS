...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidInputEventConfig_TraceRuleDefaultTypeInternal _AndroidInputEventConfig_TraceRule_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AndroidInputEventConfigDefaultTypeInternal _AndroidInputEventConfig_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class AndroidInputEventConfig_TraceRule::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidInputEventConfig_TraceRule>()._has_bits_);
...
AndroidInputEventConfig_TraceRule::AndroidInputEventConfig_TraceRule(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  match_all_packages_(arena),
  match_any_packages_(arena) {
  SharedCtor();
...
AndroidInputEventConfig_TraceRule::AndroidInputEventConfig_TraceRule(const AndroidInputEventConfig_TraceRule& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      ...
      match_all_packages_(from.match_all_packages_),
      match_any_packages_(from.match_any_packages_) {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&trace_level_, &from.trace_level_,
    static_cast<size_t>(reinterpret_cast<char*>(&match_ime_connection_active_) -
    reinterpret_cast<char*>(&trace_level_)) + sizeof(match_ime_connection_active_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&trace_level_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&match_ime_connection_active_) -
    reinterpret_cast<char*>(&trace_level_)) + sizeof(match_ime_connection_active_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.AndroidInputEventConfig.TraceRule)
  ...
  if (cached_has_bits & 0x00000007u) {
    ::memset(&trace_level_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&match_ime_connection_active_) -
        reinterpret_cast<char*>(&trace_level_)) + sizeof(match_ime_connection_active_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          match_secure_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          match_ime_connection_active_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.AndroidInputEventConfig.TraceRule)
  ...
  // repeated string match_all_packages = 2;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(match_all_packages_.size());
  for (int i = 0, n = match_all_packages_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      match_all_packages_.Get(i));
  }

  // repeated string match_any_packages = 3;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(match_any_packages_.size());
  for (int i = 0, n = match_any_packages_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      match_any_packages_.Get(i));
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.AndroidInputEventConfig.TraceRule)
  ...
  match_all_packages_.MergeFrom(from.match_all_packages_);
  match_any_packages_.MergeFrom(from.match_any_packages_);
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      match_secure_ = from.match_secure_;
    }
    if (cached_has_bits & 0x00000004u) {
      match_ime_connection_active_ = from.match_ime_connection_active_;
    }
...
void AndroidInputEventConfig_TraceRule::InternalSwap(AndroidInputEventConfig_TraceRule* other) {
  ...
  match_all_packages_.InternalSwap(&other->match_all_packages_);
  match_any_packages_.InternalSwap(&other->match_any_packages_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidInputEventConfig_TraceRule, match_ime_connection_active_)
      + sizeof(AndroidInputEventConfig_TraceRule::match_ime_connection_active_)
      - PROTOBUF_FIELD_OFFSET(AndroidInputEventConfig_TraceRule, trace_level_)>(
          reinterpret_cast<char*>(&trace_level_),
          reinterpret_cast<char*>(&other->trace_level_));
}
...
class AndroidInputEventConfig::_Internal {
 public:
  using HasBits = decltype(std::declval<AndroidInputEventConfig>()._has_bits_);
...
AndroidInputEventConfig::AndroidInputEventConfig(const AndroidInputEventConfig& from)
  ...
  ::memcpy(&mode_, &from.mode_,
    static_cast<size_t>(reinterpret_cast<char*>(&trace_dispatcher_window_dispatch_) -
    reinterpret_cast<char*>(&mode_)) + sizeof(trace_dispatcher_window_dispatch_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&trace_dispatcher_window_dispatch_) -
    reinterpret_cast<char*>(&mode_)) + sizeof(trace_dispatcher_window_dispatch_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.AndroidInputEventConfig)
  ...
  if (cached_has_bits & 0x00000007u) {
    ::memset(&mode_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&trace_dispatcher_window_dispatch_) -
        reinterpret_cast<char*>(&mode_)) + sizeof(trace_dispatcher_window_dispatch_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          trace_dispatcher_input_events_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          trace_dispatcher_window_dispatch_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.AndroidInputEventConfig)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      trace_dispatcher_input_events_ = from.trace_dispatcher_input_events_;
    }
    if (cached_has_bits & 0x00000004u) {
      trace_dispatcher_window_dispatch_ = from.trace_dispatcher_window_dispatch_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
...
void AndroidInputEventConfig::InternalSwap(AndroidInputEventConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AndroidInputEventConfig, trace_dispatcher_window_dispatch_)
      + sizeof(AndroidInputEventConfig::trace_dispatcher_window_dispatch_)
      - PROTOBUF_FIELD_OFFSET(AndroidInputEventConfig, mode_)>(
