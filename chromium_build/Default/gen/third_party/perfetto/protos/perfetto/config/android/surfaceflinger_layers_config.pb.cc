...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SurfaceFlingerLayersConfigDefaultTypeInternal _SurfaceFlingerLayersConfig_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class SurfaceFlingerLayersConfig::_Internal {
 public:
  using HasBits = decltype(std::declval<SurfaceFlingerLayersConfig>()._has_bits_);
...
SurfaceFlingerLayersConfig::SurfaceFlingerLayersConfig(const SurfaceFlingerLayersConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      ...
      trace_flags_(from.trace_flags_) {
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.SurfaceFlingerLayersConfig)
  ...
  trace_flags_.MergeFrom(from.trace_flags_);
...
void SurfaceFlingerLayersConfig::InternalSwap(SurfaceFlingerLayersConfig* other) {
  ...
  trace_flags_.InternalSwap(&other->trace_flags_);
