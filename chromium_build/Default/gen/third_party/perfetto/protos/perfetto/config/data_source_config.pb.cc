...
DataSourceConfig::_Internal::android_input_event_config(const DataSourceConfig* msg) {
  return *msg->android_input_event_config_;
}
...
void DataSourceConfig::clear_android_input_event_config() {
  if (android_input_event_config_ != nullptr) android_input_event_config_->Clear();
...
DataSourceConfig::DataSourceConfig(const DataSourceConfig& from)
  ...
  if (from._internal_has_etw_config()) {
    etw_config_ = new ::perfetto::protos::EtwConfig(*from.etw_config_);
  } else {
    etw_config_ = nullptr;
  }
  ...
  if (from._internal_has_android_input_event_config()) {
    android_input_event_config_ = new ::perfetto::protos::AndroidInputEventConfig(*from.android_input_event_config_);
  } else {
    android_input_event_config_ = nullptr;
  }
...
inline void DataSourceConfig::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete android_input_event_config_;
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.DataSourceConfig)
  ...
  if (cached_has_bits & 0x7f000000u) {
    ...
    if (cached_has_bits & 0x04000000u) {
      GOOGLE_DCHECK(etw_config_ != nullptr);
      etw_config_->Clear();
    }
    ...
    if (cached_has_bits & 0x20000000u) {
      GOOGLE_DCHECK(android_input_event_config_ != nullptr);
      android_input_event_config_->Clear();
    }
  ...
  if (cached_has_bits & 0x0000003fu) {
    ::memset(&trace_duration_ms_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&enable_extra_guardrails_) -
        reinterpret_cast<char*>(&trace_duration_ms_)) + sizeof(enable_extra_guardrails_));
  }
  _has_bits_.Clear();
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.DataSourceConfig)
  ...
  if (cached_has_bits & 0xff000000u) {
    ...
    if (cached_has_bits & 0x20000000u) {
      _internal_mutable_android_input_event_config()->::perfetto::protos::AndroidInputEventConfig::MergeFrom(from._internal_android_input_event_config());
    }
    if (cached_has_bits & 0x40000000u) {
