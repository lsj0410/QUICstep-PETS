...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 EtwConfigDefaultTypeInternal _EtwConfig_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
EtwConfig::EtwConfig(const EtwConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      kernel_flags_(from.kernel_flags_) {
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.EtwConfig)
  ...
  kernel_flags_.MergeFrom(from.kernel_flags_);
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
void EtwConfig::InternalSwap(EtwConfig* other) {
  ...
  kernel_flags_.InternalSwap(&other->kernel_flags_);
}
