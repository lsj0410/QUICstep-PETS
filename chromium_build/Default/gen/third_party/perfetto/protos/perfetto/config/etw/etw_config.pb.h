...
inline ::perfetto::protos::EtwConfig_KernelFlag EtwConfig::_internal_kernel_flags(int index) const {
  return static_cast< ::perfetto::protos::EtwConfig_KernelFlag >(kernel_flags_.Get(index));
}
