...
FtraceConfig::FtraceConfig(const FtraceConfig& from)
  ...
  ::memcpy(&buffer_size_kb_, &from.buffer_size_kb_,
    static_cast<size_t>(reinterpret_cast<char*>(&drain_buffer_percent_) -
    reinterpret_cast<char*>(&buffer_size_kb_)) + sizeof(drain_buffer_percent_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&drain_buffer_percent_) -
    reinterpret_cast<char*>(&compact_sched_)) + sizeof(drain_buffer_percent_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.FtraceConfig)
  ...
  if (cached_has_bits & 0x00007f00u) {
    ::memset(&disable_generic_events_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&drain_buffer_percent_) -
        reinterpret_cast<char*>(&disable_generic_events_)) + sizeof(drain_buffer_percent_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
}
    ...
    switch (tag >> 3) {
      ...
      case 26:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 208)) {
          ...
          drain_buffer_percent_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 27:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 216)) {
          ...
          buffer_size_lower_bound_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.FtraceConfig)
  ...
  if (cached_has_bits & 0x00007f00u) {
    ...
    if (cached_has_bits & 0x00002000u) {
      buffer_size_lower_bound_ = from.buffer_size_lower_bound_;
    }
    if (cached_has_bits & 0x00004000u) {
      drain_buffer_percent_ = from.drain_buffer_percent_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
...
void FtraceConfig::InternalSwap(FtraceConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FtraceConfig, drain_buffer_percent_)
      + sizeof(FtraceConfig::drain_buffer_percent_)
