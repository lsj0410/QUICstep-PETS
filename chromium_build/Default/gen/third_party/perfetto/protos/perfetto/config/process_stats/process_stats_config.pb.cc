...
ProcessStatsConfig::ProcessStatsConfig(const ProcessStatsConfig& from)
  ...
  ::memcpy(&proc_stats_poll_ms_, &from.proc_stats_poll_ms_,
    static_cast<size_t>(reinterpret_cast<char*>(&record_process_runtime_) -
    reinterpret_cast<char*>(&proc_stats_poll_ms_)) + sizeof(record_process_runtime_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&record_process_runtime_) -
    reinterpret_cast<char*>(&proc_stats_poll_ms_)) + sizeof(record_process_runtime_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.ProcessStatsConfig)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ::memset(&proc_stats_poll_ms_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&record_process_runtime_) -
        reinterpret_cast<char*>(&proc_stats_poll_ms_)) + sizeof(record_process_runtime_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 80)) {
          ...
          scan_smaps_rollup_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 88)) {
          ...
          record_process_age_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 12:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 96)) {
          ...
          record_process_runtime_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.ProcessStatsConfig)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000020u) {
      scan_smaps_rollup_ = from.scan_smaps_rollup_;
    }
    if (cached_has_bits & 0x00000040u) {
      record_process_age_ = from.record_process_age_;
    }
    if (cached_has_bits & 0x00000080u) {
      record_process_runtime_ = from.record_process_runtime_;
    }
...
void ProcessStatsConfig::InternalSwap(ProcessStatsConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ProcessStatsConfig, record_process_runtime_)
      + sizeof(ProcessStatsConfig::record_process_runtime_)
