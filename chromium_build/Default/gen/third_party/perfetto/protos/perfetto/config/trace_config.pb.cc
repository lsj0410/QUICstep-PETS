...
TraceConfig_BufferConfig::TraceConfig_BufferConfig(const TraceConfig_BufferConfig& from)
  ...
  ::memcpy(&size_kb_, &from.size_kb_,
    static_cast<size_t>(reinterpret_cast<char*>(&clear_before_clone_) -
    reinterpret_cast<char*>(&size_kb_)) + sizeof(clear_before_clone_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&clear_before_clone_) -
    reinterpret_cast<char*>(&size_kb_)) + sizeof(clear_before_clone_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TraceConfig.BufferConfig)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ::memset(&size_kb_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&clear_before_clone_) -
        reinterpret_cast<char*>(&size_kb_)) + sizeof(clear_before_clone_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          transfer_on_clone_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          ...
          clear_before_clone_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.TraceConfig.BufferConfig)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      transfer_on_clone_ = from.transfer_on_clone_;
    }
    if (cached_has_bits & 0x00000008u) {
      clear_before_clone_ = from.clear_before_clone_;
    }
...
void TraceConfig_BufferConfig::InternalSwap(TraceConfig_BufferConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TraceConfig_BufferConfig, clear_before_clone_)
      + sizeof(TraceConfig_BufferConfig::clear_before_clone_)
