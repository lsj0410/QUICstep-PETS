...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ShellTransition_TargetDefaultTypeInternal _ShellTransition_Target_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ShellTransitionDefaultTypeInternal _ShellTransition_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ShellHandlerMappingsDefaultTypeInternal _ShellHandlerMappings_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ShellHandlerMappingDefaultTypeInternal _ShellHandlerMapping_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class ShellTransition_Target::_Internal {
 public:
  using HasBits = decltype(std::declval<ShellTransition_Target>()._has_bits_);
...
void ShellTransition_Target::InternalSwap(ShellTransition_Target* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ShellTransition_Target, flags_)
      + sizeof(ShellTransition_Target::flags_)
      - PROTOBUF_FIELD_OFFSET(ShellTransition_Target, mode_)>(
...
class ShellTransition::_Internal {
 public:
  using HasBits = decltype(std::declval<ShellTransition>()._has_bits_);
...
ShellTransition::ShellTransition(const ShellTransition& from)
  ...
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&create_time_ns_, &from.create_time_ns_,
    static_cast<size_t>(reinterpret_cast<char*>(&flags_) -
    reinterpret_cast<char*>(&create_time_ns_)) + sizeof(flags_));
  // @@protoc_insertion_point(copy_constructor:perfetto.protos.ShellTransition)
}

inline void ShellTransition::SharedCtor() {
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&create_time_ns_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&flags_) -
    reinterpret_cast<char*>(&create_time_ns_)) + sizeof(flags_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.ShellTransition)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ::memset(&create_time_ns_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&shell_abort_time_ns_) -
        reinterpret_cast<char*>(&create_time_ns_)) + sizeof(shell_abort_time_ns_));
  }
  if (cached_has_bits & 0x0000ff00u) {
    ::memset(&wm_abort_time_ns_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&flags_) -
        reinterpret_cast<char*>(&wm_abort_time_ns_)) + sizeof(flags_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          create_time_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          dispatch_time_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          merge_time_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          ...
          merge_request_time_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          ...
          shell_abort_time_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 64)) {
          ...
          wm_abort_time_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          ...
          finish_time_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 80)) {
          ...
          start_transaction_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 88)) {
          ...
          finish_transaction_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 120)) {
          ...
          merge_target_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 17:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 136)) {
          ...
          starting_window_remove_time_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.ShellTransition)
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      create_time_ns_ = from.create_time_ns_;
    }
    if (cached_has_bits & 0x00000002u) {
      send_time_ns_ = from.send_time_ns_;
    }
    if (cached_has_bits & 0x00000004u) {
      dispatch_time_ns_ = from.dispatch_time_ns_;
    }
    if (cached_has_bits & 0x00000008u) {
      merge_time_ns_ = from.merge_time_ns_;
    }
    if (cached_has_bits & 0x00000010u) {
      merge_request_time_ns_ = from.merge_request_time_ns_;
    }
    if (cached_has_bits & 0x00000020u) {
      id_ = from.id_;
    }
    ...
    if (cached_has_bits & 0x00000080u) {
      shell_abort_time_ns_ = from.shell_abort_time_ns_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x0000ff00u) {
    if (cached_has_bits & 0x00000100u) {
      wm_abort_time_ns_ = from.wm_abort_time_ns_;
    }
    if (cached_has_bits & 0x00000200u) {
      finish_time_ns_ = from.finish_time_ns_;
    }
    if (cached_has_bits & 0x00000400u) {
      start_transaction_id_ = from.start_transaction_id_;
    }
    if (cached_has_bits & 0x00000800u) {
      finish_transaction_id_ = from.finish_transaction_id_;
    }
    if (cached_has_bits & 0x00001000u) {
      type_ = from.type_;
    }
    if (cached_has_bits & 0x00002000u) {
      merge_target_ = from.merge_target_;
    }
    if (cached_has_bits & 0x00004000u) {
      starting_window_remove_time_ns_ = from.starting_window_remove_time_ns_;
    }
    if (cached_has_bits & 0x00008000u) {
      flags_ = from.flags_;
    }
...
void ShellTransition::InternalSwap(ShellTransition* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ShellTransition, flags_)
      + sizeof(ShellTransition::flags_)
      - PROTOBUF_FIELD_OFFSET(ShellTransition, create_time_ns_)>(
          reinterpret_cast<char*>(&create_time_ns_),
          reinterpret_cast<char*>(&other->create_time_ns_));
}
...
class ShellHandlerMapping::_Internal {
 public:
  using HasBits = decltype(std::declval<ShellHandlerMapping>()._has_bits_);
  static void set_has_id(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
