...
PROTOBUF_CONSTEXPR CSwitchEtwEvent::CSwitchEtwEvent(
  ...
  , old_thread_wait_reason_(0)

  , old_thread_wait_mode_(0)
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CSwitchEtwEventDefaultTypeInternal _CSwitchEtwEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ReadyThreadEtwEventDefaultTypeInternal _ReadyThreadEtwEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class CSwitchEtwEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<CSwitchEtwEvent>()._has_bits_);
...
CSwitchEtwEvent::CSwitchEtwEvent(const CSwitchEtwEvent& from)
  ...
  ::memcpy(&new_thread_id_, &from.new_thread_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&new_thread_wait_time_) -
    reinterpret_cast<char*>(&new_thread_id_)) + sizeof(new_thread_wait_time_));
  // @@protoc_insertion_point(copy_constructor:perfetto.protos.CSwitchEtwEvent)
}

inline void CSwitchEtwEvent::SharedCtor() {
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&new_thread_id_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&new_thread_wait_time_) -
    reinterpret_cast<char*>(&new_thread_id_)) + sizeof(new_thread_wait_time_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.CSwitchEtwEvent)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ::memset(&new_thread_id_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&old_thread_state_) -
        reinterpret_cast<char*>(&new_thread_id_)) + sizeof(old_thread_state_));
  }
  if (cached_has_bits & 0x00000300u) {
    ::memset(&old_thread_wait_ideal_processor_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&new_thread_wait_time_) -
        reinterpret_cast<char*>(&old_thread_wait_ideal_processor_)) + sizeof(new_thread_wait_time_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          new_thread_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          old_thread_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          new_thread_priority_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarintZigZag32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          old_thread_priority_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarintZigZag32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          previous_c_state_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          ...
          old_thread_wait_ideal_processor_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarintZigZag32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 80)) {
          ...
          new_thread_wait_time_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.CSwitchEtwEvent)
  ...
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
      new_thread_id_ = from.new_thread_id_;
    }
    if (cached_has_bits & 0x00000002u) {
      old_thread_id_ = from.old_thread_id_;
    }
    if (cached_has_bits & 0x00000004u) {
      new_thread_priority_ = from.new_thread_priority_;
    }
    if (cached_has_bits & 0x00000008u) {
      old_thread_priority_ = from.old_thread_priority_;
    }
    if (cached_has_bits & 0x00000010u) {
      previous_c_state_ = from.previous_c_state_;
    }
    if (cached_has_bits & 0x00000020u) {
      old_thread_wait_reason_ = from.old_thread_wait_reason_;
    }
    if (cached_has_bits & 0x00000040u) {
      old_thread_wait_mode_ = from.old_thread_wait_mode_;
    }
    if (cached_has_bits & 0x00000080u) {
      old_thread_state_ = from.old_thread_state_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00000300u) {
    if (cached_has_bits & 0x00000100u) {
      old_thread_wait_ideal_processor_ = from.old_thread_wait_ideal_processor_;
    }
    if (cached_has_bits & 0x00000200u) {
      new_thread_wait_time_ = from.new_thread_wait_time_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
...
void CSwitchEtwEvent::InternalSwap(CSwitchEtwEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CSwitchEtwEvent, new_thread_wait_time_)
      + sizeof(CSwitchEtwEvent::new_thread_wait_time_)
      - PROTOBUF_FIELD_OFFSET(CSwitchEtwEvent, new_thread_id_)>(
          reinterpret_cast<char*>(&new_thread_id_),
          reinterpret_cast<char*>(&other->new_thread_id_));
}
...
class ReadyThreadEtwEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<ReadyThreadEtwEvent>()._has_bits_);
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.ReadyThreadEtwEvent)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ::memset(&t_thread_id_, 0, static_cast<size_t>(
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          t_thread_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          adjust_increment_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarintZigZag32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.ReadyThreadEtwEvent)
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      t_thread_id_ = from.t_thread_id_;
    }
    if (cached_has_bits & 0x00000002u) {
      adjust_reason_ = from.adjust_reason_;
    }
    if (cached_has_bits & 0x00000004u) {
      adjust_increment_ = from.adjust_increment_;
    }
    if (cached_has_bits & 0x00000008u) {
      flag_ = from.flag_;
    }
...
void ReadyThreadEtwEvent::InternalSwap(ReadyThreadEtwEvent* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ReadyThreadEtwEvent, flag_)
      + sizeof(ReadyThreadEtwEvent::flag_)
      - PROTOBUF_FIELD_OFFSET(ReadyThreadEtwEvent, t_thread_id_)>(
          reinterpret_cast<char*>(&t_thread_id_),
          reinterpret_cast<char*>(&other->t_thread_id_));
}
