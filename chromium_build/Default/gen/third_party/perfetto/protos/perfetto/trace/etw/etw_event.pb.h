...
inline ::perfetto::protos::CSwitchEtwEvent* EtwTraceEvent::release_c_switch() {
  ...
  if (_internal_has_c_switch()) {
    clear_has_event();
    ::perfetto::protos::CSwitchEtwEvent* temp = event_.c_switch_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    event_.c_switch_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::perfetto::protos::CSwitchEtwEvent* EtwTraceEvent::_internal_mutable_c_switch() {
  if (!_internal_has_c_switch()) {
    clear_event();
    set_has_c_switch();
    event_.c_switch_ = CreateMaybeMessage< ::perfetto::protos::CSwitchEtwEvent >(GetArenaForAllocation());
  }
  return event_.c_switch_;
}
...
inline ::perfetto::protos::ReadyThreadEtwEvent* EtwTraceEvent::release_ready_thread() {
  ...
  if (_internal_has_ready_thread()) {
    clear_has_event();
    ::perfetto::protos::ReadyThreadEtwEvent* temp = event_.ready_thread_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    event_.ready_thread_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::perfetto::protos::ReadyThreadEtwEvent* EtwTraceEvent::_internal_mutable_ready_thread() {
  if (!_internal_has_ready_thread()) {
    clear_event();
    set_has_ready_thread();
    event_.ready_thread_ = CreateMaybeMessage< ::perfetto::protos::ReadyThreadEtwEvent >(GetArenaForAllocation());
  }
  return event_.ready_thread_;
}
...
inline EtwTraceEvent::EventCase EtwTraceEvent::event_case() const {
  return EtwTraceEvent::EventCase(_oneof_case_[0]);
}
#ifdef __GNUC__
