...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 BinderCommandFtraceEventDefaultTypeInternal _BinderCommandFtraceEvent_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 BinderReturnFtraceEventDefaultTypeInternal _BinderReturnFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class BinderCommandFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<BinderCommandFtraceEvent>()._has_bits_);
...
class BinderReturnFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<BinderReturnFtraceEvent>()._has_bits_);
  static void set_has_cmd(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
};
