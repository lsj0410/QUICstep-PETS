...
class BinderCommandFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(BinderCommandFtraceEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  BinderCommandFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class BinderReturnFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(BinderReturnFtraceEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  BinderReturnFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
