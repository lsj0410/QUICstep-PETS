...
class PERFETTO_EXPORT_COMPONENT FtraceEvent : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_common_flags() const { return _has_field_[5]; }
  uint32_t common_flags() const { return common_flags_; }
  void set_common_flags(uint32_t value) { common_flags_ = value; _has_field_.set(5); }
  ...
  bool has_suspend_resume_minimal() const { return _has_field_[481]; }
  const SuspendResumeMinimalFtraceEvent& suspend_resume_minimal() const { return *suspend_resume_minimal_; }
  SuspendResumeMinimalFtraceEvent* mutable_suspend_resume_minimal() { _has_field_.set(481); return suspend_resume_minimal_.get(); }

  bool has_mali_mali_csf_interrupt_start() const { return _has_field_[482]; }
  const MaliMaliCSFINTERRUPTSTARTFtraceEvent& mali_mali_csf_interrupt_start() const { return *mali_mali_csf_interrupt_start_; }
  MaliMaliCSFINTERRUPTSTARTFtraceEvent* mutable_mali_mali_csf_interrupt_start() { _has_field_.set(482); return mali_mali_csf_interrupt_start_.get(); }

  bool has_mali_mali_csf_interrupt_end() const { return _has_field_[483]; }
  const MaliMaliCSFINTERRUPTENDFtraceEvent& mali_mali_csf_interrupt_end() const { return *mali_mali_csf_interrupt_end_; }
  MaliMaliCSFINTERRUPTENDFtraceEvent* mutable_mali_mali_csf_interrupt_end() { _has_field_.set(483); return mali_mali_csf_interrupt_end_.get(); }

  bool has_samsung_tracing_mark_write() const { return _has_field_[484]; }
  const SamsungTracingMarkWriteFtraceEvent& samsung_tracing_mark_write() const { return *samsung_tracing_mark_write_; }
  SamsungTracingMarkWriteFtraceEvent* mutable_samsung_tracing_mark_write() { _has_field_.set(484); return samsung_tracing_mark_write_.get(); }

  bool has_binder_command() const { return _has_field_[485]; }
  const BinderCommandFtraceEvent& binder_command() const { return *binder_command_; }
  BinderCommandFtraceEvent* mutable_binder_command() { _has_field_.set(485); return binder_command_.get(); }

  bool has_binder_return() const { return _has_field_[486]; }
  ...
  bool has_rpm_status() const { return _has_field_[489]; }
  const RpmStatusFtraceEvent& rpm_status() const { return *rpm_status_; }
  RpmStatusFtraceEvent* mutable_rpm_status() { _has_field_.set(489); return rpm_status_.get(); }

  bool has_panel_write_generic() const { return _has_field_[490]; }
  const PanelWriteGenericFtraceEvent& panel_write_generic() const { return *panel_write_generic_; }
  PanelWriteGenericFtraceEvent* mutable_panel_write_generic() { _has_field_.set(490); return panel_write_generic_.get(); }

  bool has_sched_migrate_task() const { return _has_field_[491]; }
  const SchedMigrateTaskFtraceEvent& sched_migrate_task() const { return *sched_migrate_task_; }
  SchedMigrateTaskFtraceEvent* mutable_sched_migrate_task() { _has_field_.set(491); return sched_migrate_task_.get(); }
 ...
 private:
  ...
  ::protozero::CopyablePtr<SuspendResumeMinimalFtraceEvent> suspend_resume_minimal_;
  ::protozero::CopyablePtr<MaliMaliCSFINTERRUPTSTARTFtraceEvent> mali_mali_csf_interrupt_start_;
  ::protozero::CopyablePtr<MaliMaliCSFINTERRUPTENDFtraceEvent> mali_mali_csf_interrupt_end_;
  ...
  ::protozero::CopyablePtr<RpmStatusFtraceEvent> rpm_status_;
  ::protozero::CopyablePtr<PanelWriteGenericFtraceEvent> panel_write_generic_;
  ::protozero::CopyablePtr<SchedMigrateTaskFtraceEvent> sched_migrate_task_;

  // Allows to preserve unknown protobuf fields for compatibility
  // with future versions of .proto files.
  std::string unknown_fields_;

  std::bitset<492> _has_field_{};
};
