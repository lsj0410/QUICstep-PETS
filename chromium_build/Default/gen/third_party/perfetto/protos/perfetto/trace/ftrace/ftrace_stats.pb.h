...
class FtraceCpuStats final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(FtraceCpuStats* other) {
...
class FtraceStats final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(FtraceStats* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
void FtraceStats::set_atrace_errors(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 atrace_errors_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* FtraceStats::release_atrace_errors() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = atrace_errors_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (atrace_errors_.IsDefault()) {
...
inline void FtraceStats::set_allocated_atrace_errors(std::string* atrace_errors) {
  ...
  atrace_errors_.SetAllocated(atrace_errors, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (atrace_errors_.IsDefault()) {
    atrace_errors_.Set("", GetArenaForAllocation());
  }
...
inline int FtraceStats::_internal_unknown_ftrace_events_size() const {
  return unknown_ftrace_events_.size();
}
...
inline const std::string& FtraceStats::_internal_unknown_ftrace_events(int index) const {
  return unknown_ftrace_events_.Get(index);
}
...
inline std::string* FtraceStats::mutable_unknown_ftrace_events(int index) {
  ...
  return unknown_ftrace_events_.Mutable(index);
}
inline void FtraceStats::set_unknown_ftrace_events(int index, const std::string& value) {
  unknown_ftrace_events_.Mutable(index)->assign(value);
...
inline void FtraceStats::set_unknown_ftrace_events(int index, std::string&& value) {
  unknown_ftrace_events_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:perfetto.protos.FtraceStats.unknown_ftrace_events)
}
...
inline void FtraceStats::set_unknown_ftrace_events(int index, const char* value, size_t size) {
  unknown_ftrace_events_.Mutable(index)->assign(
...
inline std::string* FtraceStats::_internal_add_unknown_ftrace_events() {
  return unknown_ftrace_events_.Add();
}
inline void FtraceStats::add_unknown_ftrace_events(const std::string& value) {
  unknown_ftrace_events_.Add()->assign(value);
...
inline void FtraceStats::add_unknown_ftrace_events(std::string&& value) {
  unknown_ftrace_events_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:perfetto.protos.FtraceStats.unknown_ftrace_events)
}
...
inline void FtraceStats::add_unknown_ftrace_events(const char* value, size_t size) {
  unknown_ftrace_events_.Add()->assign(reinterpret_cast<const char*>(value), size);
...
inline int FtraceStats::_internal_failed_ftrace_events_size() const {
  return failed_ftrace_events_.size();
}
...
inline const std::string& FtraceStats::_internal_failed_ftrace_events(int index) const {
  return failed_ftrace_events_.Get(index);
}
...
inline std::string* FtraceStats::mutable_failed_ftrace_events(int index) {
  ...
  return failed_ftrace_events_.Mutable(index);
}
inline void FtraceStats::set_failed_ftrace_events(int index, const std::string& value) {
  failed_ftrace_events_.Mutable(index)->assign(value);
...
inline void FtraceStats::set_failed_ftrace_events(int index, std::string&& value) {
  failed_ftrace_events_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:perfetto.protos.FtraceStats.failed_ftrace_events)
}
...
inline void FtraceStats::set_failed_ftrace_events(int index, const char* value, size_t size) {
  failed_ftrace_events_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
...
inline void FtraceStats::add_failed_ftrace_events(std::string&& value) {
  failed_ftrace_events_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:perfetto.protos.FtraceStats.failed_ftrace_events)
}
...
inline void FtraceStats::add_failed_ftrace_events(const char* value, size_t size) {
  failed_ftrace_events_.Add()->assign(reinterpret_cast<const char*>(value), size);
...
inline int FtraceStats::_internal_ftrace_parse_errors_size() const {
  return ftrace_parse_errors_.size();
}
...
inline ::perfetto::protos::FtraceParseStatus FtraceStats::_internal_ftrace_parse_errors(int index) const {
  return static_cast< ::perfetto::protos::FtraceParseStatus >(ftrace_parse_errors_.Get(index));
}
...
inline void FtraceStats::set_ftrace_parse_errors(int index, ::perfetto::protos::FtraceParseStatus value) {
  ...
  ftrace_parse_errors_.Set(index, value);
...
inline void FtraceStats::_internal_add_ftrace_parse_errors(::perfetto::protos::FtraceParseStatus value) {
  assert(::perfetto::protos::FtraceParseStatus_IsValid(value));
  ftrace_parse_errors_.Add(value);
}
