...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PanelWriteGenericFtraceEventDefaultTypeInternal _PanelWriteGenericFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class PanelWriteGenericFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<PanelWriteGenericFtraceEvent>()._has_bits_);
...
void PanelWriteGenericFtraceEvent::InternalSwap(PanelWriteGenericFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PanelWriteGenericFtraceEvent, value_)
      + sizeof(PanelWriteGenericFtraceEvent::value_)
      - PROTOBUF_FIELD_OFFSET(PanelWriteGenericFtraceEvent, pid_)>(
