...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GpuWorkPeriodFtraceEventDefaultTypeInternal _GpuWorkPeriodFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class GpuWorkPeriodFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<GpuWorkPeriodFtraceEvent>()._has_bits_);
  static void set_has_gpu_id(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
...
GpuWorkPeriodFtraceEvent::GpuWorkPeriodFtraceEvent(const GpuWorkPeriodFtraceEvent& from)
  ...
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&gpu_id_, &from.gpu_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&total_active_duration_ns_) -
    reinterpret_cast<char*>(&gpu_id_)) + sizeof(total_active_duration_ns_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&gpu_id_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&total_active_duration_ns_) -
    reinterpret_cast<char*>(&gpu_id_)) + sizeof(total_active_duration_ns_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.GpuWorkPeriodFtraceEvent)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ::memset(&gpu_id_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&total_active_duration_ns_) -
        reinterpret_cast<char*>(&gpu_id_)) + sizeof(total_active_duration_ns_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          start_time_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          end_time_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          total_active_duration_ns_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.GpuWorkPeriodFtraceEvent)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      start_time_ns_ = from.start_time_ns_;
    }
    if (cached_has_bits & 0x00000008u) {
      end_time_ns_ = from.end_time_ns_;
    }
    if (cached_has_bits & 0x00000010u) {
      total_active_duration_ns_ = from.total_active_duration_ns_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
...
void GpuWorkPeriodFtraceEvent::InternalSwap(GpuWorkPeriodFtraceEvent* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(GpuWorkPeriodFtraceEvent, total_active_duration_ns_)
      + sizeof(GpuWorkPeriodFtraceEvent::total_active_duration_ns_)
      - PROTOBUF_FIELD_OFFSET(GpuWorkPeriodFtraceEvent, gpu_id_)>(
          reinterpret_cast<char*>(&gpu_id_),
          reinterpret_cast<char*>(&other->gpu_id_));
}
