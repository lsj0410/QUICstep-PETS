...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SchedMigrateTaskFtraceEventDefaultTypeInternal _SchedMigrateTaskFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class SchedMigrateTaskFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<SchedMigrateTaskFtraceEvent>()._has_bits_);
  static void set_has_comm(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static void set_has_pid(HasBits* has_bits) {
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          orig_cpu_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          dest_cpu_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          ...
          running_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.SchedMigrateTaskFtraceEvent)
  ...
  if (cached_has_bits & 0x0000007fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      orig_cpu_ = from.orig_cpu_;
    }
    if (cached_has_bits & 0x00000010u) {
      dest_cpu_ = from.dest_cpu_;
    }
    if (cached_has_bits & 0x00000020u) {
...
void SchedMigrateTaskFtraceEvent::InternalSwap(SchedMigrateTaskFtraceEvent* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SchedMigrateTaskFtraceEvent, load_)
      + sizeof(SchedMigrateTaskFtraceEvent::load_)
      - PROTOBUF_FIELD_OFFSET(SchedMigrateTaskFtraceEvent, pid_)>(
          reinterpret_cast<char*>(&pid_),
          reinterpret_cast<char*>(&other->pid_));
}
