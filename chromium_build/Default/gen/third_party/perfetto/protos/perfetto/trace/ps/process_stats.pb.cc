...
ProcessStats_Process::ProcessStats_Process(const ProcessStats_Process& from)
  ...
  ::memcpy(&vm_size_kb_, &from.vm_size_kb_,
    static_cast<size_t>(reinterpret_cast<char*>(&runtime_kernel_mode_) -
    reinterpret_cast<char*>(&vm_size_kb_)) + sizeof(runtime_kernel_mode_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&runtime_kernel_mode_) -
    reinterpret_cast<char*>(&vm_size_kb_)) + sizeof(runtime_kernel_mode_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.ProcessStats.Process)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ::memset(&vm_locked_kb_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&smr_pss_anon_kb_) -
        reinterpret_cast<char*>(&vm_locked_kb_)) + sizeof(smr_pss_anon_kb_));
  }
  if (cached_has_bits & 0x000f0000u) {
    ::memset(&smr_pss_file_kb_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&runtime_kernel_mode_) -
        reinterpret_cast<char*>(&smr_pss_file_kb_)) + sizeof(runtime_kernel_mode_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
}
    ...
    switch (tag >> 3) {
      ...
      case 16:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 128)) {
          ...
          smr_rss_kb_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 17:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 136)) {
          ...
          smr_pss_kb_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 18:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 144)) {
          ...
          smr_pss_anon_kb_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 19:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 152)) {
          ...
          smr_pss_file_kb_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 20:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 160)) {
          ...
          smr_pss_shmem_kb_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 21:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 168)) {
          ...
          runtime_user_mode_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 22:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 176)) {
          ...
          runtime_kernel_mode_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.ProcessStats.Process)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    if (cached_has_bits & 0x00002000u) {
      smr_rss_kb_ = from.smr_rss_kb_;
    }
    if (cached_has_bits & 0x00004000u) {
      smr_pss_kb_ = from.smr_pss_kb_;
    }
    if (cached_has_bits & 0x00008000u) {
      smr_pss_anon_kb_ = from.smr_pss_anon_kb_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x000f0000u) {
    if (cached_has_bits & 0x00010000u) {
      smr_pss_file_kb_ = from.smr_pss_file_kb_;
    }
    if (cached_has_bits & 0x00020000u) {
      smr_pss_shmem_kb_ = from.smr_pss_shmem_kb_;
    }
    if (cached_has_bits & 0x00040000u) {
      runtime_user_mode_ = from.runtime_user_mode_;
    }
    if (cached_has_bits & 0x00080000u) {
      runtime_kernel_mode_ = from.runtime_kernel_mode_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
...
void ProcessStats_Process::InternalSwap(ProcessStats_Process* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ProcessStats_Process, runtime_kernel_mode_)
      + sizeof(ProcessStats_Process::runtime_kernel_mode_)
