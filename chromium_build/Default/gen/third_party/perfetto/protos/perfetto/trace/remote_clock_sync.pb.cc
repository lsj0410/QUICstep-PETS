...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RemoteClockSync_SyncedClocksDefaultTypeInternal _RemoteClockSync_SyncedClocks_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RemoteClockSyncDefaultTypeInternal _RemoteClockSync_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class RemoteClockSync_SyncedClocks::_Internal {
 public:
  using HasBits = decltype(std::declval<RemoteClockSync_SyncedClocks>()._has_bits_);
...
RemoteClockSync_SyncedClocks::RemoteClockSync_SyncedClocks(const RemoteClockSync_SyncedClocks& from)
  ...
  if (from._internal_has_client_clocks()) {
    client_clocks_ = new ::perfetto::protos::ClockSnapshot(*from.client_clocks_);
  } else {
    client_clocks_ = nullptr;
  }
  if (from._internal_has_host_clocks()) {
    host_clocks_ = new ::perfetto::protos::ClockSnapshot(*from.host_clocks_);
  } else {
    host_clocks_ = nullptr;
  }
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&client_clocks_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&host_clocks_) -
    reinterpret_cast<char*>(&client_clocks_)) + sizeof(host_clocks_));
}
...
inline void RemoteClockSync_SyncedClocks::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete client_clocks_;
  if (this != internal_default_instance()) delete host_clocks_;
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.RemoteClockSync.SyncedClocks)
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      GOOGLE_DCHECK(client_clocks_ != nullptr);
      client_clocks_->Clear();
    }
    if (cached_has_bits & 0x00000002u) {
      GOOGLE_DCHECK(host_clocks_ != nullptr);
      host_clocks_->Clear();
    }
  }
  _has_bits_.Clear();
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.RemoteClockSync.SyncedClocks)
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _internal_mutable_client_clocks()->::perfetto::protos::ClockSnapshot::MergeFrom(from._internal_client_clocks());
    }
    if (cached_has_bits & 0x00000002u) {
      _internal_mutable_host_clocks()->::perfetto::protos::ClockSnapshot::MergeFrom(from._internal_host_clocks());
    }
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
void RemoteClockSync_SyncedClocks::InternalSwap(RemoteClockSync_SyncedClocks* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RemoteClockSync_SyncedClocks, host_clocks_)
      + sizeof(RemoteClockSync_SyncedClocks::host_clocks_)
      - PROTOBUF_FIELD_OFFSET(RemoteClockSync_SyncedClocks, client_clocks_)>(
          reinterpret_cast<char*>(&client_clocks_),
          reinterpret_cast<char*>(&other->client_clocks_));
}
...
RemoteClockSync::RemoteClockSync(const RemoteClockSync& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(),
      synced_clocks_(from.synced_clocks_) {
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.RemoteClockSync)
  ...
  for (const auto& msg : this->synced_clocks_) {
    total_size +=
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.RemoteClockSync)
  ...
  synced_clocks_.MergeFrom(from.synced_clocks_);
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
void RemoteClockSync::InternalSwap(RemoteClockSync* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  synced_clocks_.InternalSwap(&other->synced_clocks_);
}
