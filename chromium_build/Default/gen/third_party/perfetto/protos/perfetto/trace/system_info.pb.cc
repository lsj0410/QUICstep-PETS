...
SystemInfo::SystemInfo(const SystemInfo& from)
  ...
  ::memcpy(&hz_, &from.hz_,
    ...
    reinterpret_cast<char*>(&hz_)) + sizeof(num_cpus_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&num_cpus_) -
    reinterpret_cast<char*>(&utsname_)) + sizeof(num_cpus_));
}
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          ...
          timezone_off_mins_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 64)) {
          ...
          num_cpus_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.SystemInfo)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000040u) {
      timezone_off_mins_ = from.timezone_off_mins_;
    }
    if (cached_has_bits & 0x00000080u) {
...
void SystemInfo::InternalSwap(SystemInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SystemInfo, num_cpus_)
      + sizeof(SystemInfo::num_cpus_)
