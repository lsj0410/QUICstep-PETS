...
TracePacket::_Internal::surfaceflinger_layers_snapshot(const TracePacket* msg) {
  return *msg->data_.surfaceflinger_layers_snapshot_;
}
...
TracePacket::_Internal::remote_clock_sync(const TracePacket* msg) {
  return *msg->data_.remote_clock_sync_;
}
...
void TracePacket::clear_surfaceflinger_layers_snapshot() {
  if (_internal_has_surfaceflinger_layers_snapshot()) {
    if (GetArenaForAllocation() == nullptr) {
      delete data_.surfaceflinger_layers_snapshot_;
    }
    clear_has_data();
  }
}
...
void TracePacket::clear_surfaceflinger_transactions() {
  if (_internal_has_surfaceflinger_transactions()) {
    if (GetArenaForAllocation() == nullptr) {
      delete data_.surfaceflinger_transactions_;
    }
    clear_has_data();
  }
}
...
void TracePacket::clear_remote_clock_sync() {
  if (_internal_has_remote_clock_sync()) {
    if (GetArenaForAllocation() == nullptr) {
      delete data_.remote_clock_sync_;
    }
    clear_has_data();
  }
}
...
TracePacket::TracePacket(const TracePacket& from)
  ...
  switch (from.data_case()) {
    ...
    case kSurfaceflingerLayersSnapshot: {
      _internal_mutable_surfaceflinger_layers_snapshot()->::perfetto::protos::LayersSnapshotProto::MergeFrom(from._internal_surfaceflinger_layers_snapshot());
      break;
    }
    ...
    case kRemoteClockSync: {
      _internal_mutable_remote_clock_sync()->::perfetto::protos::RemoteClockSync::MergeFrom(from._internal_remote_clock_sync());
      break;
    }
    case kForTesting: {
