...
inline void TracePacket::set_has_surfaceflinger_layers_snapshot() {
  _oneof_case_[0] = kSurfaceflingerLayersSnapshot;
}
inline ::perfetto::protos::LayersSnapshotProto* TracePacket::release_surfaceflinger_layers_snapshot() {
  ...
  if (_internal_has_surfaceflinger_layers_snapshot()) {
    clear_has_data();
    ::perfetto::protos::LayersSnapshotProto* temp = data_.surfaceflinger_layers_snapshot_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.surfaceflinger_layers_snapshot_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline const ::perfetto::protos::LayersSnapshotProto& TracePacket::_internal_surfaceflinger_layers_snapshot() const {
  return _internal_has_surfaceflinger_layers_snapshot()
      ? *data_.surfaceflinger_layers_snapshot_
...
inline void TracePacket::unsafe_arena_set_allocated_surfaceflinger_layers_snapshot(::perfetto::protos::LayersSnapshotProto* surfaceflinger_layers_snapshot) {
  ...
  if (surfaceflinger_layers_snapshot) {
    ...
    data_.surfaceflinger_layers_snapshot_ = surfaceflinger_layers_snapshot;
  }
...
inline ::perfetto::protos::LayersSnapshotProto* TracePacket::_internal_mutable_surfaceflinger_layers_snapshot() {
  if (!_internal_has_surfaceflinger_layers_snapshot()) {
    clear_data();
    set_has_surfaceflinger_layers_snapshot();
    data_.surfaceflinger_layers_snapshot_ = CreateMaybeMessage< ::perfetto::protos::LayersSnapshotProto >(GetArenaForAllocation());
  }
  return data_.surfaceflinger_layers_snapshot_;
}
...
inline void TracePacket::set_has_surfaceflinger_transactions() {
  _oneof_case_[0] = kSurfaceflingerTransactions;
}
inline ::perfetto::protos::TransactionTraceEntry* TracePacket::release_surfaceflinger_transactions() {
  ...
  if (_internal_has_surfaceflinger_transactions()) {
    clear_has_data();
    ::perfetto::protos::TransactionTraceEntry* temp = data_.surfaceflinger_transactions_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.surfaceflinger_transactions_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline void TracePacket::unsafe_arena_set_allocated_surfaceflinger_transactions(::perfetto::protos::TransactionTraceEntry* surfaceflinger_transactions) {
  ...
  if (surfaceflinger_transactions) {
    ...
    data_.surfaceflinger_transactions_ = surfaceflinger_transactions;
  }
...
inline ::perfetto::protos::TransactionTraceEntry* TracePacket::_internal_mutable_surfaceflinger_transactions() {
  if (!_internal_has_surfaceflinger_transactions()) {
    clear_data();
    set_has_surfaceflinger_transactions();
    data_.surfaceflinger_transactions_ = CreateMaybeMessage< ::perfetto::protos::TransactionTraceEntry >(GetArenaForAllocation());
  }
  return data_.surfaceflinger_transactions_;
}
...
inline ::perfetto::protos::EtwTraceEventBundle* TracePacket::release_etw_events() {
  ...
  if (_internal_has_etw_events()) {
    clear_has_data();
    ::perfetto::protos::EtwTraceEventBundle* temp = data_.etw_events_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.etw_events_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::perfetto::protos::EtwTraceEventBundle* TracePacket::_internal_mutable_etw_events() {
  if (!_internal_has_etw_events()) {
    clear_data();
    set_has_etw_events();
    data_.etw_events_ = CreateMaybeMessage< ::perfetto::protos::EtwTraceEventBundle >(GetArenaForAllocation());
  }
  return data_.etw_events_;
}
...
inline void TracePacket::set_has_remote_clock_sync() {
  _oneof_case_[0] = kRemoteClockSync;
}
inline ::perfetto::protos::RemoteClockSync* TracePacket::release_remote_clock_sync() {
  ...
  if (_internal_has_remote_clock_sync()) {
    clear_has_data();
    ::perfetto::protos::RemoteClockSync* temp = data_.remote_clock_sync_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.remote_clock_sync_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline void TracePacket::unsafe_arena_set_allocated_remote_clock_sync(::perfetto::protos::RemoteClockSync* remote_clock_sync) {
  ...
  if (remote_clock_sync) {
    ...
    data_.remote_clock_sync_ = remote_clock_sync;
  }
...
inline ::perfetto::protos::RemoteClockSync* TracePacket::_internal_mutable_remote_clock_sync() {
  if (!_internal_has_remote_clock_sync()) {
    clear_data();
    set_has_remote_clock_sync();
    data_.remote_clock_sync_ = CreateMaybeMessage< ::perfetto::protos::RemoteClockSync >(GetArenaForAllocation());
  }
  return data_.remote_clock_sync_;
}
