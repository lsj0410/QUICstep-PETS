...
inline bool TracePacketDefaults::_internal_has_track_event_defaults() const {
  ...
  PROTOBUF_ASSUME(!value || track_event_defaults_ != nullptr);
  return value;
}
...
inline bool TracePacketDefaults::_internal_has_perf_sample_defaults() const {
  ...
  PROTOBUF_ASSUME(!value || perf_sample_defaults_ != nullptr);
  return value;
}
...
inline bool TracePacketDefaults::_internal_has_v8_code_defaults() const {
  ...
  PROTOBUF_ASSUME(!value || v8_code_defaults_ != nullptr);
  return value;
}
...
inline const ::perfetto::protos::V8CodeDefaults& TracePacketDefaults::_internal_v8_code_defaults() const {
  const ::perfetto::protos::V8CodeDefaults* p = v8_code_defaults_;
...
inline void TracePacketDefaults::unsafe_arena_set_allocated_v8_code_defaults(
    ::perfetto::protos::V8CodeDefaults* v8_code_defaults) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(v8_code_defaults_);
  }
  v8_code_defaults_ = v8_code_defaults;
  if (v8_code_defaults) {
...
inline ::perfetto::protos::V8CodeDefaults* TracePacketDefaults::release_v8_code_defaults() {
  _has_bits_[0] &= ~0x00000004u;
  ::perfetto::protos::V8CodeDefaults* temp = v8_code_defaults_;
