 ...
 public:
  ...
  struct Row : public macros_internal::RootParentTable::Row {
    Row(uint32_t in_node_id = {},
        ...
        : macros_internal::RootParentTable::Row(),
          ...
          in_start_node_id(in_in_start_node_id) {
  ...
  class Iterator : public ConstIterator {
    ...
    private:
     ...
     explicit Iterator(DfsTable* table, Table::Iterator iterator)
        : ConstIterator(table, std::move(iterator)),
          mutable_table_(table) {}
  ...
  static std::vector<ColumnLegacy> GetColumns(
    ...
    AddColumnToVector(columns, "in_dest_node_ids", &self->in_dest_node_ids_, ColumnFlag::in_dest_node_ids,
                      static_cast<uint32_t>(columns.size()), olay_idx);
    AddColumnToVector(columns, "in_start_node_id", &self->in_start_node_id_, ColumnFlag::in_start_node_id,
                      static_cast<uint32_t>(columns.size()), olay_idx);
    return columns;
  }

  PERFETTO_NO_INLINE explicit DfsTable(StringPool* pool)
      : macros_internal::MacroTable(
          pool,
...
,
        ...
        in_source_node_ids_storage_layer_(
          new column::StringStorage(string_pool(), &in_source_node_ids_.vector())),
        in_dest_node_ids_storage_layer_(
          new column::StringStorage(string_pool(), &in_dest_node_ids_.vector())),
        in_start_node_id_storage_layer_(
          new column::NumericStorage<ColumnType::in_start_node_id::non_optional_stored_type>(
            &in_start_node_id_.non_null_vector(),
            ColumnTypeHelper<ColumnType::in_start_node_id::stored_type>::ToColumnType(),
            false))
,
        parent_node_id_null_layer_(new column::NullOverlay(parent_node_id_.bv())),
        in_start_node_id_null_layer_(new column::NullOverlay(in_start_node_id_.bv())) {
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,node_id_storage_layer_,parent_node_id_storage_layer_,in_source_node_ids_storage_layer_,in_dest_node_ids_storage_layer_,in_start_node_id_storage_layer_},
      {{},{},{},parent_node_id_null_layer_,{},{},in_start_node_id_null_layer_});
  }
  ~DfsTable() override;
  ...
  IdAndRow Insert(const Row& row) {
    ...
    mutable_in_start_node_id()->Append(row.in_start_node_id);
    UpdateSelfOverlayAfterInsert();
    return IdAndRow{id, row_number, RowReference(this, row_number),
                     RowNumber(row_number)};
  }
  ...
  const TypedColumn<std::optional<uint32_t>>& in_start_node_id() const {
    return static_cast<const ColumnType::in_start_node_id&>(columns()[ColumnIndex::in_start_node_id]);
  }
  ...
  TypedColumn<std::optional<uint32_t>>* mutable_in_start_node_id() {
    return static_cast<ColumnType::in_start_node_id*>(
        GetColumn(ColumnIndex::in_start_node_id));
  }
 ...
 private:
  ...
  RefPtr<column::DataLayer> in_start_node_id_storage_layer_;

  RefPtr<column::DataLayer> parent_node_id_null_layer_;
  RefPtr<column::DataLayer> in_start_node_id_null_layer_;
};
...
class DominatorTreeTable : public macros_internal::MacroTable {
 public:
  ...
  struct Row : public macros_internal::RootParentTable::Row {
    Row(uint32_t in_node_id = {},
        ...
        : macros_internal::RootParentTable::Row(),
          ...
          in_source_node_ids(in_in_source_node_ids),
          in_dest_node_ids(in_in_dest_node_ids),
          in_root_node_id(in_in_root_node_id) {
  ...
  static std::vector<ColumnLegacy> GetColumns(
    ...
    AddColumnToVector(columns, "in_dest_node_ids", &self->in_dest_node_ids_, ColumnFlag::in_dest_node_ids,
                      static_cast<uint32_t>(columns.size()), olay_idx);
    AddColumnToVector(columns, "in_root_node_id", &self->in_root_node_id_, ColumnFlag::in_root_node_id,
                      static_cast<uint32_t>(columns.size()), olay_idx);
    return columns;
  }
...
,
        ...
        in_dest_node_ids_storage_layer_(
          new column::StringStorage(string_pool(), &in_dest_node_ids_.vector())),
        in_root_node_id_storage_layer_(
          new column::NumericStorage<ColumnType::in_root_node_id::non_optional_stored_type>(
            &in_root_node_id_.non_null_vector(),
            ColumnTypeHelper<ColumnType::in_root_node_id::stored_type>::ToColumnType(),
            false))
,
        dominator_node_id_null_layer_(new column::NullOverlay(dominator_node_id_.bv())),
        in_root_node_id_null_layer_(new column::NullOverlay(in_root_node_id_.bv())) {
    static_assert(
        ColumnLegacy::IsFlagsAndTypeValid<ColumnType::node_id::stored_type>(
          ColumnFlag::node_id),
        "Column type and flag combination is not valid");
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,node_id_storage_layer_,dominator_node_id_storage_layer_,in_source_node_ids_storage_layer_,in_dest_node_ids_storage_layer_,in_root_node_id_storage_layer_},
      {{},{},{},dominator_node_id_null_layer_,{},{},in_root_node_id_null_layer_});
  }
  ...
  IdAndRow Insert(const Row& row) {
    ...
    mutable_in_source_node_ids()->Append(row.in_source_node_ids);
    mutable_in_dest_node_ids()->Append(row.in_dest_node_ids);
    mutable_in_root_node_id()->Append(row.in_root_node_id);
    UpdateSelfOverlayAfterInsert();
    return IdAndRow{id, row_number, RowReference(this, row_number),
                     RowNumber(row_number)};
  }
  ...
  const TypedColumn<std::optional<uint32_t>>& in_root_node_id() const {
    return static_cast<const ColumnType::in_root_node_id&>(columns()[ColumnIndex::in_root_node_id]);
  }
  ...
  TypedColumn<std::optional<uint32_t>>* mutable_in_root_node_id() {
    return static_cast<ColumnType::in_root_node_id*>(
        GetColumn(ColumnIndex::in_root_node_id));
  }
 ...
 private:
  ...
  RefPtr<column::DataLayer> in_source_node_ids_storage_layer_;
  RefPtr<column::DataLayer> in_dest_node_ids_storage_layer_;
  RefPtr<column::DataLayer> in_root_node_id_storage_layer_;

  RefPtr<column::DataLayer> dominator_node_id_null_layer_;
  RefPtr<column::DataLayer> in_root_node_id_null_layer_;
};
 ...
 public:
  ...
  struct Row : public SchedSliceTable::Row {
    Row(int64_t in_ts = {},
        ...
        std::nullptr_t = nullptr)
        : SchedSliceTable::Row(in_ts, in_dur, in_cpu, in_utid, in_end_state, in_priority),
          upid(in_upid) {
...
,
    ...
    static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {const_parent_->storage_layers()[ColumnIndex::id],const_parent_->storage_layers()[ColumnIndex::type],const_parent_->storage_layers()[ColumnIndex::ts],const_parent_->storage_layers()[ColumnIndex::dur],const_parent_->storage_layers()[ColumnIndex::cpu],const_parent_->storage_layers()[ColumnIndex::utid],const_parent_->storage_layers()[ColumnIndex::end_state],const_parent_->storage_layers()[ColumnIndex::priority],upid_storage_layer_},
      {{},{},{},{},{},{},{},{},upid_null_layer_});
  }
...
,
    ...
    OnConstructionCompleted(
      {const_parent_->storage_layers()[ColumnIndex::id],const_parent_->storage_layers()[ColumnIndex::type],const_parent_->storage_layers()[ColumnIndex::ts],const_parent_->storage_layers()[ColumnIndex::dur],const_parent_->storage_layers()[ColumnIndex::cpu],const_parent_->storage_layers()[ColumnIndex::utid],const_parent_->storage_layers()[ColumnIndex::end_state],const_parent_->storage_layers()[ColumnIndex::priority],upid_storage_layer_}, {{},{},{},{},{},{},{},{},upid_null_layer_}, std::move(overlay_layers));
  }
