...
,
    ...
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,pid_storage_layer_,name_storage_layer_,start_ts_storage_layer_,end_ts_storage_layer_,parent_upid_storage_layer_,uid_storage_layer_,android_appid_storage_layer_,cmdline_storage_layer_,arg_set_id_storage_layer_},
      {{},{},{},{},start_ts_null_layer_,end_ts_null_layer_,parent_upid_null_layer_,uid_null_layer_,android_appid_null_layer_,{},{}});
  }
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,tid_storage_layer_,name_storage_layer_,start_ts_storage_layer_,end_ts_storage_layer_,upid_storage_layer_,is_main_thread_storage_layer_},
      {{},{},{},{},start_ts_null_layer_,end_ts_null_layer_,upid_null_layer_,is_main_thread_null_layer_});
  }
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,ts_storage_layer_,clock_id_storage_layer_,clock_name_storage_layer_,clock_value_storage_layer_,snapshot_id_storage_layer_},
      {{},{},{},{},{},{},{}});
  }
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,cluster_id_storage_layer_,processor_storage_layer_},
      {{},{},{},{}});
  }
  ~CpuTable() override;
 ...
 public:
  ...
  static std::vector<ColumnLegacy> GetColumns(
    ...
    std::vector<ColumnLegacy> columns =
        CopyColumnsFromParentOrAddRootColumns(self, parent);
    uint32_t olay_idx = OverlayCount(parent);
    AddColumnToVector(columns, "cpu_id", &self->cpu_id_, ColumnFlag::cpu_id,
                      static_cast<uint32_t>(columns.size()), olay_idx);
...
,
        ...
        type_storage_layer_(
          new column::StringStorage(string_pool(), &type_.vector())),
        cpu_id_storage_layer_(
        new column::NumericStorage<ColumnType::cpu_id::non_optional_stored_type>(
          &cpu_id_.vector(),
          ColumnTypeHelper<ColumnType::cpu_id::stored_type>::ToColumnType(),
          false)),
        freq_storage_layer_(
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,cpu_id_storage_layer_,freq_storage_layer_},
      {{},{},{},{}});
  }
  ...
  IdAndRow Insert(const Row& row) {
    ...
    Id id = Id{row_number};
    type_.Append(string_pool()->InternString(row.type()));
    mutable_cpu_id()->Append(row.cpu_id);
  ...
  const TypedColumn<CpuTable::Id>& cpu_id() const {
    return static_cast<const ColumnType::cpu_id&>(columns()[ColumnIndex::cpu_id]);
  }
 ...
 private:
  ...
  RefPtr<column::DataLayer> id_storage_layer_;
  RefPtr<column::DataLayer> type_storage_layer_;
  RefPtr<column::DataLayer> cpu_id_storage_layer_;
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,ts_storage_layer_,name_storage_layer_,cpu_storage_layer_,utid_storage_layer_,arg_set_id_storage_layer_,common_flags_storage_layer_},
      {{},{},{},{},{},{},{},{}});
  }
  ~RawTable() override;
 ...
 public:
  ...
  struct Row : public RawTable::Row {
    Row(int64_t in_ts = {},
        ...
        uint32_t in_common_flags = {},
        std::nullptr_t = nullptr)
        : RawTable::Row(in_ts, in_name, in_cpu, in_utid, in_arg_set_id, in_common_flags)
           {
      type_ = "ftrace_event";
    }
  ...
  PERFETTO_NO_INLINE explicit FtraceEventTable(StringPool* pool, RawTable* parent)
    ...
    OnConstructionCompletedRegularConstructor(
      {const_parent_->storage_layers()[ColumnIndex::id],const_parent_->storage_layers()[ColumnIndex::type],const_parent_->storage_layers()[ColumnIndex::ts],const_parent_->storage_layers()[ColumnIndex::name],const_parent_->storage_layers()[ColumnIndex::cpu],const_parent_->storage_layers()[ColumnIndex::utid],const_parent_->storage_layers()[ColumnIndex::arg_set_id],const_parent_->storage_layers()[ColumnIndex::common_flags]},
      {{},{},{},{},{},{},{},{}});
  }
 ...
 private:
  FtraceEventTable(StringPool* pool,
    ...
    OnConstructionCompleted(
      {const_parent_->storage_layers()[ColumnIndex::id],const_parent_->storage_layers()[ColumnIndex::type],const_parent_->storage_layers()[ColumnIndex::ts],const_parent_->storage_layers()[ColumnIndex::name],const_parent_->storage_layers()[ColumnIndex::cpu],const_parent_->storage_layers()[ColumnIndex::utid],const_parent_->storage_layers()[ColumnIndex::arg_set_id],const_parent_->storage_layers()[ColumnIndex::common_flags]}, {{},{},{},{},{},{},{},{}}, std::move(overlay_layers));
  }
