...
,
    ...
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,ts_storage_layer_,dur_storage_layer_,cpu_storage_layer_,utid_storage_layer_,end_state_storage_layer_,priority_storage_layer_},
      {{},{},{},{},{},{},{},{}});
  }
...
class ThreadStateTable : public macros_internal::MacroTable {
 public:
  ...
  struct ColumnIndex {
    ...
    static constexpr uint32_t waker_id = 10;
    static constexpr uint32_t irq_context = 11;
  };
  struct ColumnType {
...
,
    ...
    static_assert(
      ...
      static_assert(
        ...
        "Column type and flag combination is not valid");
    OnConstructionCompletedRegularConstructor(
      {id_storage_layer_,type_storage_layer_,ts_storage_layer_,dur_storage_layer_,cpu_storage_layer_,utid_storage_layer_,state_storage_layer_,io_wait_storage_layer_,blocked_function_storage_layer_,waker_utid_storage_layer_,waker_id_storage_layer_,irq_context_storage_layer_},
      {{},{},{},{},cpu_null_layer_,{},{},io_wait_null_layer_,{},waker_utid_null_layer_,waker_id_null_layer_,irq_context_null_layer_});
  }
